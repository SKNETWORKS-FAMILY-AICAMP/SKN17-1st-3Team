...
* 한국공학한림원 2023년도 2월, [칼럼] 자동차 분야 탄소중립 전략
<br>
...
🔹[전기승용 구매보조금 연도별 지자체별 현황]
- 출처: 한국환경공단
- 수집 방법: 한국환경공단에서 제공하는 연도별 보조금 자료 크롤링
- 데이터 출처 및 범위
   - 수집 데이터 기간: 2020년 ~ 2024년
   - 데이터 규모: 약 17,000여 개의 데이터
   - 지역적 범위: 전국
   - 주요 변수
      : 연도, 지역, 연료종류, 보조금 금액
- 데이터 설명
     : 한국환경공단에서 대한민국 보조금 지급의 기초자료로 활용하기 위해 지자체별로 등록된 보조금을 파악한 자료로 지역별 지자체별 현황 자료임.
       연도별 차량 수와 분포(차종, 연료별)를 지역별 기준에 따라 등록 현황을 판단할 수 있으며, 본 프로젝트에서는 이 데이터를 기반으로 지역별 보조금 변동이 친환경차량에 주는 영향 파악에 활용하였음.
...
🔹[기업 FAQ 자료]
- 출처: 기아, 현대, BMW, 쉐보레, 폴스타
- 수집 방법: 각 기업 FAQ 사이트 크롤링
- 주요 변수: 질문, 답변
- 데이터 설명
     : 각 기업의 FAQ 사이트에서 질문에 대한 답을 크롤링하여 자주 묻는 질문을 streamlit에서 바로 확인할 수 있도록 활용하였음.
...
![메인](https://github.com/SKNETWORKS-FAMILY-AICAMP/SKN17-1st-3Team/blob/main/image/streamlit_2/1.png)
<br>

![2](https://github.com/SKNETWORKS-FAMILY-AICAMP/SKN17-1st-3Team/blob/main/image/streamlit_2/2.png)
<br>
...
![5](https://github.com/SKNETWORKS-FAMILY-AICAMP/SKN17-1st-3Team/blob/main/image/streamlit_2/5.png)
<br>
